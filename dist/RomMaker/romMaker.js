...
RomPatcher.prototype.applyUPR = function () {
    ...
    cheerpjRunMain("com.dabomstew.pkrandom.cli.CliRandomizer", "/app/RomMaker/UPR.jar", "-s", "/str/config.rnqs.json", "-i", "/str/rom.gba", "-o",  "/files/result.gba", "--seed", getHash(this.romSeed).toString()).then(() => {
